...
/**
 * An exception thrown if a buffer access if out of bounds. Interop exceptions are supposed to be
 * caught and converted into a guest language error by the caller.
 *
 * @see #getByteOffset()
 * @see #getLength()
 * @see InteropLibrary
