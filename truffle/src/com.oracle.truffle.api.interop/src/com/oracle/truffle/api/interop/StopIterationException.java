 ...
 * <p>
 * This exception is thrown by the {@link InteropLibrary#getIteratorNextElement
 * getIteratorNextElement} when the iterator has no more elements to return.
 * <p>
 * Interop exceptions are supposed to be caught and converted into a guest language error by the
 * caller.
 *
 * @see InteropLibrary
 * @since 21.1
